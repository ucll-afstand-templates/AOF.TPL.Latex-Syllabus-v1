...
% maakt het mogelijk op ook te compileren vanuit een deelbestand
...
Voor langere stukken gebruik je \code{lstlisting}. Je kan verwijzen naar een bepaalde lijn met een label, bijvoorbeeld ``zie code in lijn \ref{line:userRepo}''.  Bekijk de broncode om te zien hoe je het moet doen. Code tussen de symbolen \code{£} wordt niet als code gezien, maar als \LaTeX-code. Je kan het gebruikte symbool aanpassen in het bestand huisstijl/settings, lijn 96.
